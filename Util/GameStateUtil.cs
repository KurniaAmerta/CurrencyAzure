...
namespace PlayFab.TicTacToeDemo.Util
{
    public static class GameStateUtil
    {
        ...
        public static async Task Currency(string type, int amount, string playFabId, PlayFabApiSettings apiSettings, PlayFabAuthenticationContext authenticationContext)
        {
